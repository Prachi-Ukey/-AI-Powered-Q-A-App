...
function App() {
  ...
  return (
    ...
    <div className="grid grid-cols-5 h-screen text-center">
      ...
      <div className="col-span-4 p-15">
        <h1 className="text-4xl bg-clip-text text-transparent bg-gradient-to-r from-pink-700 to-violet-700 mb-10">Hell User, Ask Me Anything</h1>
        {
          loader?
          <div role="status">
    ...
    <span className="sr-only">Loading...</span>
        ...
        <div ref={scrollToAns} className="container mb-20 h-120 overflow-auto">
